              ...
              <ul className="flex items-center gap-1">
                {menu.map((item, index) => (
                  <li key={index}>
                    <a 
                      href={item.link} 
                      className="relative px-5 py-2.5 text-sm font-bold text-gray-300 transition-all duration-300 group overflow-hidden rounded-lg"
                    >
                ...
                {menu.map((item, index) => (
                  <li key={index}>
                    <a 
                      ...
                      className="relative block px-4 py-3 text-sm font-bold text-gray-300 transition-all duration-300 rounded-lg group overflow-hidden"
                    >
